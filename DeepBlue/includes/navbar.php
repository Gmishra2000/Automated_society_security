...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <li class="nav-item">
    ...
    <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="user.php">Residents</a>
        <a class="collapse-item" href="admin_visitor_register.php">Visitor</a>
  ...
  <li class="nav-item">
    <a class="nav-link" href="admin_user-profile.php">
      <i class="fas fa-fw fa-chart-area"></i>
      <span>Residents Profile</span> <input type="hidden"></a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="admin_visitor_profile.php">
      <i class="fas fa-fw fa-chart-area"></i>
